...
SET FILE1=\\%comp%\C$\Program Files (x86)\Microsoft Office\Office15\EXCEL.EXE
SET FILE2=%FILE1: (x86)=%
if exist "%FILE1%" (
...
IF "%File_Version%" NEQ "Not Found" GOTO :GotVer
SET FILE1=\\%comp%\C$\Program Files (x86)\Microsoft Office\Office14\EXCEL.EXE
SET FILE2=%FILE1: (x86)=%
if exist "%FILE1%" (
	for /F "tokens=5" %%a in ('filever "%FILE1%"') do set File_Version=%%a
) Else (
...
IF "%File_Version%" NEQ "Not Found" GOTO :GotVer
SET FILE1=\\%comp%\C$\Program Files (x86)\Microsoft Office\Office12\EXCEL.EXE
SET FILE2=%FILE1: (x86)=%
if exist "%FILE1%" (
	for /F "tokens=5" %%a in ('filever "%FILE1%"') do set File_Version=%%a
) Else (
