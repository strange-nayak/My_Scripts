...
:Need to enumerate each ocx file (hopefully only one)
for %%a in (\\%comp%\admin$\System32\Macromed\Flash\Flash*.ocx) do for /F "tokens=5" %%b in ('filever "%%a"') do set File_Version=%%b
