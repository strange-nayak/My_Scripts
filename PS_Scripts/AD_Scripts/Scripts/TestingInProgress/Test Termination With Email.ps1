...
$Email=whoami /upn
$ToEmailAddress = 'helpdeskopshyd@broadridge.com'

#Importing Users from CSV file

$Users = Import-Csv -Path "C:\Scripts\Term_List.csv"
...
Write-host $User
 ...
 $Names= Get-aduser -filter { employeenumber -eq $EmpID } -Server bsg.ad.adp.com:3268 -Properties * | select name, samaccountname ,userprincipalname ,Displayname ,mail ,Description
...
$body1 = $Data | Select-Object -Property EmpID,ADUser,Email,Samaccountname,Description,Remarks | ConvertTo-Html -Head $Header -body $body

$fromaddress = $Email 
$toaddress = $ToEmailAddress
$CCaddress = "Ravi.chanda@broadridge.com" 
